...
# oauth2-mcp Rakefile v7.0.0 - 2026-05-28
...
# rake install                                # Build and install oauth2-mcp-1.0.0.gem in...
# rake install:local                          # Build and install oauth2-mcp-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template oauth2-mcp against itse...
