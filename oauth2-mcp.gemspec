...
Gem::Specification.new do |spec|
  ...
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/oauth2/mcp/version.rb", mod) }::OAuth2::MCP::Version::VERSION
  ...
  spec.add_dependency("oauth2", "~> 2.0", ">= 2.0.21")                  # ruby >= 2.2.0
  ...
  spec.add_development_dependency("kettle-dev", "~> 2.1", ">= 2.1.0")      # ruby >= 3.2.0
  ...
  # The 'git' gem is optional; oauth2-mcp falls back to shelling out to `git` if it is not present.
