...
|-------------------------------------------------|-----------------------------------------------------------------------|---------------------------|--------------------------|---------------------------|--------------------------|------------------------------|
| 🧪 [ruby-oauth/oauth2-mcp on GitLab][📜src-gl] | The Truth | [💚][🤝gl-issues] | [💚][🤝gl-pulls] | [💚][📜gl-wiki] | 🐭 Tiny Matrix | ➖ |
| 🧊 [ruby-oauth/oauth2-mcp on CodeBerg][📜src-cb] | An Ethical Mirror ([Donate][🤝cb-donate]) | [💚][🤝cb-issues] | [💚][🤝cb-pulls] | ➖ | ⭕️ No Matrix | ➖ |
| 🐙 [ruby-oauth/oauth2-mcp on GitHub][📜src-gh] | Another Mirror | [💚][🤝gh-issues] | [💚][🤝gh-pulls] | [💚][📜gh-wiki] | 💯 Full Matrix | [💚][gh-discussions] |
| 🎮️ [Discord Server][✉️discord-invite] | [![Live Chat on Discord][✉️discord-invite-img-ftb]][✉️discord-invite] | [Let's][✉️discord-invite] | [talk][✉️discord-invite] | [about][✉️discord-invite] | [this][✉️discord-invite] | [library!][✉️discord-invite] |

</details>

[gh-discussions]: https://github.com/ruby-oauth/oauth2-mcp/discussions

### Enterprise Support [![Tidelift](https://tidelift.com/badges/package/rubygems/oauth2-mcp)](https://tidelift.com/subscription/pkg/rubygems-oauth2-mcp?utm_source=rubygems-oauth2-mcp&utm_medium=referral&utm_campaign=readme)
...
```console
bundle add oauth2-mcp
```

If bundler is not being used to manage dependencies, install the gem by executing:

```console
gem install oauth2-mcp
```
...
<a href="https://star-history.com/ruby-oauth/oauth2-mcp&Date">
 <picture>
 <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=ruby-oauth/oauth2-mcp&type=Date&theme=dark" />
 <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=ruby-oauth/oauth2-mcp&type=Date" />
 <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=ruby-oauth/oauth2-mcp&type=Date" />
 </picture>
</a>
...
```ruby
spec.add_dependency("oauth2-mcp", "~> 0.0")
```
...
[⛳️tag-img]: https://img.shields.io/github/tag/ruby-oauth/oauth2-mcp.svg
[⛳️tag]: https://github.com/ruby-oauth/oauth2-mcp/releases
[🚂maint-blog]: http://www.railsbling.com/tags/oauth2-mcp
...
[🏙️entsup-tidelift]: https://tidelift.com/subscription/pkg/rubygems-oauth2-mcp?utm_source=rubygems-oauth2-mcp&utm_medium=referral&utm_campaign=readme
...
[📜gh-wiki]: https://github.com/ruby-oauth/oauth2-mcp/wiki
[📜gl-wiki-img]: https://img.shields.io/badge/wiki-gitlab-943CD2.svg?style=for-the-badge&logo=gitlab&logoColor=white
[📜gh-wiki-img]: https://img.shields.io/badge/wiki-github-943CD2.svg?style=for-the-badge&logo=github&logoColor=white
[👽dl-rank]: https://bestgems.org/gems/oauth2-mcp
[👽dl-ranki]: https://img.shields.io/gem/rd/oauth2-mcp.svg
[👽version]: https://bestgems.org/gems/oauth2-mcp
[👽versioni]: https://img.shields.io/gem/v/oauth2-mcp.svg
[🏀qlty-mnt]: https://qlty.sh/gh/ruby-oauth/projects/oauth2-mcp
[🏀qlty-mnti]: https://qlty.sh/gh/ruby-oauth/projects/oauth2-mcp/maintainability.svg
[🏀qlty-cov]: https://qlty.sh/gh/ruby-oauth/projects/oauth2-mcp/metrics/code?sort=coverageRating
[🏀qlty-covi]: https://qlty.sh/gh/ruby-oauth/projects/oauth2-mcp/coverage.svg
[🏀codecov]: https://codecov.io/gh/ruby-oauth/oauth2-mcp
...
[🚎3-hd-wfi]: https://github.com/ruby-oauth/oauth2-mcp/actions/workflows/heads.yml/badge.svg
[🚎5-st-wf]: https://github.com/ruby-oauth/oauth2-mcp/actions/workflows/style.yml
[🚎5-st-wfi]: https://github.com/ruby-oauth/oauth2-mcp/actions/workflows/style.yml/badge.svg
[🚎9-t-wf]: https://github.com/ruby-oauth/oauth2-mcp/actions/workflows/truffle.yml
[🚎9-t-wfi]: https://github.com/ruby-oauth/oauth2-mcp/actions/workflows/truffle.yml/badge.svg
[🚎10-j-wf]: https://github.com/ruby-oauth/oauth2-mcp/actions/workflows/jruby.yml
[🚎10-j-wfi]: https://github.com/ruby-oauth/oauth2-mcp/actions/workflows/jruby.yml/badge.svg
[🚎11-c-wf]: https://github.com/ruby-oauth/oauth2-mcp/actions/workflows/current.yml
[🚎11-c-wfi]: https://github.com/ruby-oauth/oauth2-mcp/actions/workflows/current.yml/badge.svg
[🚎12-crh-wf]: https://github.com/ruby-oauth/oauth2-mcp/actions/workflows/dep-heads.yml
[🚎12-crh-wfi]: https://github.com/ruby-oauth/oauth2-mcp/actions/workflows/dep-heads.yml/badge.svg
[🚎13-🔒️-wf]: https://github.com/ruby-oauth/oauth2-mcp/actions/workflows/locked_deps.yml
[🚎13-🔒️-wfi]: https://github.com/ruby-oauth/oauth2-mcp/actions/workflows/locked_deps.yml/badge.svg
[🚎14-🔓️-wf]: https://github.com/ruby-oauth/oauth2-mcp/actions/workflows/unlocked_deps.yml
[🚎14-🔓️-wfi]: https://github.com/ruby-oauth/oauth2-mcp/actions/workflows/unlocked_deps.yml/badge.svg
[🚎15-🪪-wf]: https://github.com/ruby-oauth/oauth2-mcp/actions/workflows/license-eye.yml
[🚎15-🪪-wfi]: https://github.com/ruby-oauth/oauth2-mcp/actions/workflows/license-eye.yml/badge.svg
...
[🤝gh-pulls]: https://github.com/ruby-oauth/oauth2-mcp/pulls
[🤝gl-issues]: https://gitlab.com/ruby-oauth/oauth2-mcp/-/issues
[🤝gl-pulls]: https://gitlab.com/ruby-oauth/oauth2-mcp/-/merge_requests
[🤝cb-issues]: https://codeberg.org/ruby-oauth/oauth2-mcp/issues
[🤝cb-pulls]: https://codeberg.org/ruby-oauth/oauth2-mcp/pulls
[🤝cb-donate]: https://donate.codeberg.org/
[🤝contributing]: https://github.com/ruby-oauth/oauth2-mcp/blob/main/CONTRIBUTING.md
[🏀codecov-g]: https://codecov.io/gh/ruby-oauth/oauth2-mcp/graph/badge.svg
[🖐contrib-rocks]: https://contrib.rocks
[🖐contributors]: https://github.com/ruby-oauth/oauth2-mcp/graphs/contributors
[🖐contributors-img]: https://contrib.rocks/image?repo=ruby-oauth/oauth2-mcp
[🚎contributors-gl]: https://gitlab.com/ruby-oauth/oauth2-mcp/-/graphs/main
...
[📌changelog]: https://github.com/ruby-oauth/oauth2-mcp/blob/main/CHANGELOG.md
[📗keep-changelog]: https://keepachangelog.com/en/1.0.0/
[📗keep-changelog-img]: https://img.shields.io/badge/keep--a--changelog-1.0.0-34495e.svg?style=flat
[📌gitmoji]: https://gitmoji.dev
[📌gitmoji-img]: https://img.shields.io/badge/gitmoji_commits-%20%F0%9F%98%9C%20%F0%9F%98%8D-34495e.svg?style=flat-square
[🧮kloc]: https://www.youtube.com/watch?v=dQw4w9WgXcQ
[🧮kloc-img]: https://img.shields.io/badge/KLOC-0.285-FFDD67.svg?style=for-the-badge&logo=YouTube&logoColor=blue
[🔐security]: https://github.com/ruby-oauth/oauth2-mcp/blob/main/SECURITY.md
...
[🚎yard-current]: http://rubydoc.info/gems/oauth2-mcp
[🚎yard-head]: https://oauth2-mcp.galtzo.com
[💎stone_checksums]: https://github.com/galtzo-floss/stone_checksums
[💎SHA_checksums]: https://gitlab.com/ruby-oauth/oauth2-mcp/-/tree/main/checksums
...
|---|---|
| Package | oauth2-mcp |
| Description | "🍲 oauth2-mcp provides Ruby helpers for securing HTTP Model Context Protocol servers " \<br>"with OAuth protected-resource metadata, bearer challenges, and scoped authorization." |
